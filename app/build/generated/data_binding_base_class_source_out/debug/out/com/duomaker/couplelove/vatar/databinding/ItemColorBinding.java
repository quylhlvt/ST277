...
public final class ItemColorBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialCardView colorSelected;

  @NonNull
  public final View viewColor;

  private ItemColorBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialCardView colorSelected, @NonNull View viewColor) {
  ...
  public static ItemColorBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.colorSelected;
      MaterialCardView colorSelected = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemColorBinding((ConstraintLayout) rootView, colorSelected, viewColor);
    }

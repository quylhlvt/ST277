...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.anime.oc.characters.avatar.utils.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.anime.oc.characters.avatar.utils.GlideOptions().apply(toSet));
    }
  }
}

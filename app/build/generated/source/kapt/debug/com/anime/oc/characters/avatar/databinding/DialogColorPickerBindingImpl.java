...
public class DialogColorPickerBindingImpl extends DialogColorPickerBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.mater3, 2);
        sViewsWithIds.put(R.id.contrainColor, 3);
        sViewsWithIds.put(R.id.tvTitle, 4);
        sViewsWithIds.put(R.id.colorPickerView, 5);
        sViewsWithIds.put(R.id.hueSlider, 6);
        sViewsWithIds.put(R.id.bg, 7);
        sViewsWithIds.put(R.id.btnCancle, 8);
        sViewsWithIds.put(R.id.imgCancleFor, 9);
        sViewsWithIds.put(R.id.txtCancle, 10);
        sViewsWithIds.put(R.id.btnSave, 11);
        sViewsWithIds.put(R.id.imgSaveFor, 12);
        sViewsWithIds.put(R.id.txtSave, 13);
    }
    // views
    @NonNull
    ...
    private DialogColorPickerBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (ir.kotlin.quyhcolorpicker.QuylhColorPicker) bindings[5]
            , (androidx.constraintlayout.widget.ConstraintLayout) bindings[3]
            , (ir.kotlin.quyhcolorpicker.QuylhHueSlider) bindings[6]

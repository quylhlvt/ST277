...
public class DialogRateBindingImpl extends DialogRateBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.material, 1);
        sViewsWithIds.put(R.id.contrainRate, 2);
        sViewsWithIds.put(R.id.imvAvtRate, 3);
        sViewsWithIds.put(R.id.tv1, 4);
        sViewsWithIds.put(R.id.tv2, 5);
        sViewsWithIds.put(R.id.ll1, 6);
        sViewsWithIds.put(R.id.btnVote, 7);
        sViewsWithIds.put(R.id.btnExit, 8);
    }
    // views
    @NonNull

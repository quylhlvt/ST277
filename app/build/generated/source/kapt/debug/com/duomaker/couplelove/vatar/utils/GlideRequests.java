...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.duomaker.couplelove.vatar.utils.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.duomaker.couplelove.vatar.utils.GlideOptions().apply(toSet));
    }
  }
}

...
class CropView : AppCompatImageView {
    ...
    suspend fun getCroppedImage(): ByteArray? {
        // Đọc trạng thái của View và tạo bitmap crop trên Main thread.
        ...
        // PNG compression là tác vụ nặng; tuyệt đối không chạy trên UI thread.
